...
public class CommandQueue extends IStatusBar.Stub {
    ...
    public interface Callbacks {
        ...
        default void handleShowShutdownUi(boolean isReboot, String reason, int rebootMode) { }
    }
    ...
    public void showShutdownUi(boolean isReboot, String reason, int rebootMode) {
        synchronized (mLock) {
            ...
            mHandler.obtainMessage(MSG_SHOW_SHUTDOWN_UI, isReboot ? 1 : 0, rebootMode, reason)
                    .sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_SHOW_SHUTDOWN_UI:
                    for (int i = 0; i < mCallbacks.size(); i++) {
                        mCallbacks.get(i).handleShowShutdownUi(msg.arg1 != 0, (String) msg.obj, msg.arg2);
                    }
                    break;
