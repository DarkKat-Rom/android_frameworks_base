...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_SHOW_SECONDS),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (uri.equals(Settings.Secure.getUriFor(
                ...
                updateBatteryBarVisibility();
                    ...
                    Settings.System.STATUS_BAR_SHOW_BATTERY_BAR_LOCK_SCREEN))) {
                updateBatteryBarVisibilityOnKeyguard();
            } else if (uri.equals(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_BATTERY_METER_SHOW_TEXT))) {
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        ((BatteryBar) mStatusBarView.findViewById(R.id.battery_bar)).setBatteryController(
                mBatteryController);
        ((BatteryBar) mKeyguardStatusBar.findViewById(R.id.battery_bar)).setBatteryController(
                mBatteryController);
    ...
    private void inflateSignalClusters() {
        ...
        SignalClusterView signalClusterViewKeyguard = reinflateSignalCluster(mKeyguardStatusBar);
        mIconController.setSignalCluster(signalClusterView);
        mIconController.setSignalClusterKeyguard(signalClusterViewKeyguard);
    }
    ...
    protected void updateNotificationColors() {
        super.updateNotificationColors();
        if (isDefaultNotificationTheme()) {
            mStackScroller.setBgColor(mContext.getColor(R.color.notification_shade_background_color));
        } else {
    ...
    private void updateNotificationDismissAllColor() {
        if (isDefaultNotificationTheme()) {
            mEmptyShadeView.setTextColor(mContext.getColor(
                    R.color.empty_shade_view_default_text_color));
            mDismissView.setTextColor(mContext.getColor(
                    R.color.notification_dismiss_all_default_text_color));
        } else {
    ...
    private void updateBatteryBarVisibility() {
        ...
        if (mIconController != null) {
            mIconController.updateBatteryBarVisibility(show);
        }
    }

    private void updateBatteryBarVisibilityOnKeyguard() {
        final boolean show = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_SHOW_BATTERY_BAR_LOCK_SCREEN, 0) == 1;
        if (mIconController != null) {
            mIconController.updateBatteryBarVisibilityOnKeyguard(show);
        }
    }
    ...
    private void updateDozingState() {
        ...
        mStackScroller.setDark(mDozing && isDefaultNotificationTheme(), animate, mWakeUpTouchLocation);
