...
struct ResTable_config
{
  ...
  enum {
    ...
    enum {
        ...
        UI_MODE_NIGHT_YES_DK = ACONFIGURATION_UI_MODE_NIGHT_YES_DK << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_DK_WHITEOUT = ACONFIGURATION_UI_MODE_NIGHT_NO_DK_WHITEOUT << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_DK = ACONFIGURATION_UI_MODE_NIGHT_NO_DK << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEOUT = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEOUT << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_DK_BLACKOUT = ACONFIGURATION_UI_MODE_NIGHT_YES_DK_BLACKOUT << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_BLACKOUT = ACONFIGURATION_UI_MODE_NIGHT_YES_BLACKOUT << SHIFT_UI_MODE_NIGHT,
    };
